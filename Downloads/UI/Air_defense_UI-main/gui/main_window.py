...
class AirDefenseGUI(QMainWindow):
    ...
    def _connect_signals_slots(self):
        ...
        # من UI إلى ROS
        self.image_view.detection_layer_changed.connect(self.ros_connector.set_view_mode)
        self.system_modes_panel.mode_changed_signal.connect(self.ros_connector.publish_mode_change)
        self.laser_power_controller.target_power_changed.connect(self.ros_connector.publish_laser_power)  # 🔥 جديد
        ...
        self.ros_connector.camera_image_ready.connect(self.image_view.set_image)
    ...
    def _handle_shoot_command(self):
        if not self.system_active:
            ...
            return
        self.log_display.add_log_entry("ACTION: FIRING LASER", True)
        self.ros_connector.publish_shoot_command()
